...
const LoginCard = ({ handleLogin }) => {
  ...
  return (
    <div className="min-h-[100vh] px-2 pt-24  bg-gray-200 flex items-center">
      <div className=" mx-auto flex flex-col w-full max-w-md  px-4 py-8 bg-slate-100 rounded-lg shadow  sm:px-6 md:px-8 lg:px-10">
        ...
        <div>
          <p className='text-xs mb-2'>you can use this email or create a new account : </p>
          <div className=' bg-slate-200 p-2 text-[14px]'>
            <p>deprueba@gmail.com</p>
            <p>ecomerce2022</p>
          </div>
        </div>
        <div className="mt-8">
          <form onSubmit={handleSubmit(onSubmit)} action="#" autoComplete="on">
