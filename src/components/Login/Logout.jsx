...
const Logout = () => {
  ...
  return (
    <div className="py-20 px-4 min-h-screen flex flex-col items-center">
      <div className="h-[10vh] w-full max-w-[1200px]">
        <ul className="flex flex-wrap items-center ml-2 mb-16 mt-4">
          <li className="mr-6">
            <Link
      ...
      <div className="flex justify-center items-center min-h-[60vh] ">
        <article className=" flex flex-col w-full max-w-[400px] overflow-hidden items-center gap-10  border-2 pb-4  mt-10 shadow-2xl rounded-xl hover:scale-105 duration-100">
          <div className='h-[200px] w-full relative'>
            <img src="./images/fondodecard.webp" className='w-full object-cover h-full ' alt="" />
            <img src="./images/userimg.png" className='absolute bottom-[-30px] left-[40%] border-2 border-white rounded-full' alt="" />
          </div>
